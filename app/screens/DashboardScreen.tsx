...
import FirebaseIoTDashboard from '@/components/FirebaseIoTDashboard';
...
const DashboardScreen: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'devices' | 'firebase'>('devices');
        ...
        <View style={{ 
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              paddingHorizontal: 16,
              borderRadius: 6,
              backgroundColor: activeTab === 'devices' ? colors.primary : 'transparent'
            }}
          >
            <ThemedText style={{
              textAlign: 'center',
              color: activeTab === 'devices' ? colors.textInverse : colors.textPrimary,
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              paddingHorizontal: 16,
              borderRadius: 6,
              backgroundColor: activeTab === 'firebase' ? colors.primary : 'transparent'
            }}
          >
            <ThemedText style={{
              textAlign: 'center',
              color: activeTab === 'firebase' ? colors.textInverse : colors.textPrimary,
